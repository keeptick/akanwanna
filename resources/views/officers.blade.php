...
<div class="col-md-12">
    ...
    <div class="tab-v1">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#home" data-toggle="tab">2016</a></li>
            <li><a href="#profile" data-toggle="tab">2015</a></li>
            <li><a href="#messages" data-toggle="tab">2014</a></li>
            <li><a href="#settings" data-toggle="tab">2013</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active" id="home">
                <div class="row">
                    <div class="parallax-team parallaxBg" style="background-position: 50% 38px;">
                        <div class="container content">
                            <div class="title-box-v2">
                                <h2>Meet Our <span class="color-green">2016 ,</span>Team</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="team-v2">
                                        <img class="img-responsive" src="{{url('')}}/preview/akawana/assets/img/team/img1-md.jpg" alt="">
                                        <div class="inner-team">
                                            <h3>{{$officer->firstname}} {{$officer->lastname}}</h3>
                                            <small class="color-green">{{$officer->position}}</small>
                                            <p>{{$officer->phone}}</p>
                                            <p>{{$officer->email}}</p>
                                            <hr>
            ...
            <div class="tab-pane fade in" id="profile">
               <div class="row">
                   <div class="parallax-team parallaxBg" style="background-position: 50% 38px;">
                       <div class="container content">
                           <div class="title-box-v2">
                               <h2>Meet Our <span class="color-green">2015 </span>Team</h2>
                               <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                           </div>
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-3 col-sm-6">
                                   <div class="team-v2">
                                       <img class="img-responsive" src="{{url('')}}/preview/akawana/assets/img/team/img2-md.jpg" alt="">
                                       <div class="inner-team">
                                           <h3>Jack Anderson</h3>
                               ...
                               <div class="col-md-3 col-sm-6">
                                   <div class="team-v2">
                                       <img class="img-responsive" src="{{url('')}}/preview/akawana/assets/img/team/img3-md.jpg" alt="">
                                       <div class="inner-team">
                                           <h3>Kate Metus</h3>
            ...
            <div class="tab-pane fade in" id="messages">
                <div class="row">
                    <div class="parallax-team parallaxBg" style="background-position: 50% 38px;">
                        <div class="container content">
                            <div class="title-box-v2">
                                <h2>Meet Our <span class="color-green">2014 </span>Team</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="team-v2">
                                        <img class="img-responsive" src="{{url('')}}/preview/akawana/assets/img/team/img5-md.jpg" alt="">
                                        <div class="inner-team">
                                            <h3>Donec Elisson</h3>
                                            <small class="color-green">Director, R &amp; D Talent</small>
                                            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem...</p>
            ...
            <div class="tab-pane fade in" id="settings">
                <div class="row">
                    <div class="parallax-team parallaxBg" style="background-position: 50% 38px;">
                        <div class="container content">
                            <div class="title-box-v2">
                                <h2>Meet Our <span class="color-green">2013 </span>Team</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
