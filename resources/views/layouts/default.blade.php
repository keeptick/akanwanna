...
<head>
    <title>Akanwanna - Responsive Website Template</title>

    <!-- Meta -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="Abdurrazaq">
    ...
    <!-- CSS Theme -->
    <link rel="stylesheet" href="{{url('')}}/preview/akawana/assets/css/theme-colors/blue.css" id="style_color">
...
<div class="style-switcher animated fadeInRight">
    ...
    <div class="style-swticher-body">
        ...
        <ul class="list-unstyled">
            ...
            <li class="theme-gold" data-style="gold" data-header="light"></li>
